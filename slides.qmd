...
-   The need for **more sustainable**, efficient, and equitable **space distribution** is growing

-   Challenge of **reallocating** street space in urban environments, dynamically
...
![](images/clipboard-1066373156.png){fig-align="center"}
...
-   Squares
-   Hexagons
-   Universal [h3 hexagon grid](https://h3geo.org/) - useful to include other variables
-   All can **vary resolution**
...
-   And be use for other purposes! out of the *Streets4All* scope
