...
```
```{r echo=FALSE}
knitr::include_graphics("img/tar_result_centrality_almada.png")
```

You can also load other objects, such as **`candidates_all`**, `candidates_centrality`, `candidates_entropy`, `candidates_traffic`, `candidates_transit`, `candidates_density`.
